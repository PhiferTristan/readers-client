...
export const Login = () => {
    const [username, setUsername] = useState("AdStraytor")
    ...
    const handleLogin = (e) => {
        ...
        fetch(`http://localhost:8000/login`, {
            ...
            .then(authInfo => {
                if (authInfo.token) {
                    localStorage.setItem("reader_token", JSON.stringify(authInfo))
        ...
        <main className="container--login">
            ...
            <section>
                <form className="form--login" onSubmit={handleLogin}>
                    ...
                    <fieldset>
                        <button 
                        type="submit" className="button p-3 rounded-md bg-blue-800 text-blue-100">
                            Sign in
                        </button>
                    </fieldset>
                </form>
