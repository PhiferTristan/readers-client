        ...
        <div className="flex flex-wrap justify-center  bg-slate-600 border border-solid border-blue-800">
          <div className="flex flex-col items-center p-10">
            ...
            <div className="review-container flex flex-col border border-solid border-blue-950 p-10">
              ...
              <button className="button bg-blue-400 rounded-md p-2 m-10 hover:bg-blue-300"
              onClick={() => navigate(`/books/${bookId}/review_form`)}>
                Leave a Review?
              </button>
              {book.reviews.length > 0 ? (
                <ul className=" flex flex-col justify-center border m-5">
                  {book.reviews.map((review) => (
                    <li
                      className="flex flex-col border p-20 space-y-10"
                      key={review.id}
                    >
